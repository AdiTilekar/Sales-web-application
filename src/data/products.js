...
export const PRODUCTS = [
  ...
  { id: 'sitafal', name: 'Sitafal', price: 25, image: `${FLAVOR_BASE_URL}sitafal_kulfi.png` },
  { id: 'gulkand', name: 'Gulkand', price: 25, image: `${FLAVOR_BASE_URL}gulkand_kulfi.png` },
  { id: 'pineapple', name: 'Pineapple', price: 25, image: `${FLAVOR_BASE_URL}pineapple_kulfi.png` },
  { id: 'red-peru', name: 'Red Peru', price: 25, image: `${FLAVOR_BASE_URL}guava_kulfi.png` },
